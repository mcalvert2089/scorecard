				...
				<form className="w-full max-w-xs" onSubmit={this.handleSubmit}>
					<div className="md:flex md:items-center mb-6">
						...
						<div className="md:w-2/3">
						  <input className="text-field" id="inline-full-name" type="text" name="name" value={this.state.name} onChange={this.handleChange}/>
						</div>
					</div>
					...
					<div className="md:flex md:items-center mb-6">
						...
						<div className="md:w-2/3">
						  <input className="text-field" id="inline-full-name" type="text" name="manager" value={this.state.manager} onChange={this.handleChange}/>
						</div>
					</div>
					...
					<div className="md:flex md:items-center mb-6">
						...
						<div className="md:w-2/3">
						  <input className="text-field" id="inline-full-name" type="text" name="city" value={this.state.city} onChange={this.handleChange}/>
						</div>
					</div>
					...
					<div className="md:flex md:items-center mb-6">
						...
						<div className="md:w-2/3">
						  <input className="text-field" id="inline-full-name" type="text" name="state" value={this.state.state} onChange={this.handleChange}/>
						</div>
						</div>
